...
code for insert image meta data into database and select image data from database.
fix error and bugs;
...
<head>
  ...
  function sortInSQL($sortParam, $db, &$pic_array)
  {
    ...
    //get_result() not support in current PHP version
  ...
  //connect to database
  $servername = "uranus.ecs.fullerton.edu";
  $username = "cs431s47";
